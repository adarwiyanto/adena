    ...
    <div class="content">
      <div class="card">
        ...
        <form method="post" style="margin-top:12px">
          ...
          <div class="row">
            <label>Cabang / Dapur untuk harga POS</label>
            <select name="branch_id"><option value="0">Tidak terikat cabang / pakai harga default</option><?php foreach ($branches as $b): ?><option value="<?php echo e((string)$b['id']); ?>"><?php echo e($b['branch_name']); ?></option><?php endforeach; ?></select>
          </div>
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div class="table-wrap"><table>
          <thead><tr><th>Nama</th><th>Kode POS</th><th>Cabang Harga</th><th>Status</th><th>Last Used</th><th>Dibuat</th><th>Aksi</th></tr></thead>
          <tbody>
          <?php foreach ($tokens as $t): ?>
            <tr>
              <td><?php echo e($t['name']); ?></td>
              <td><?php echo e((string)($t['device_code'] ?? '-')); ?></td>
              <td><?php echo e((string)($t['branch_name'] ?? 'Harga default')); ?></td>
