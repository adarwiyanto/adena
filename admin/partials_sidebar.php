  ...
  <div class="nav">
    ...
    <?php else: ?>
      ...
      <div class="item">
        ...
        <div class="submenu" id="m-produk"><a href="<?php echo e(base_url('admin/products.php')); ?>">Produk</a><a href="<?php echo e(base_url('admin/product_categories.php')); ?>">Kategori Produk</a></div>
      </div>
