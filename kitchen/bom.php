...
if ($_SERVER['REQUEST_METHOD']==='POST') {
  csrf_check();
  try {
    $finished=(int)($_POST['finished_product_id'] ?? 0); $name=trim((string)($_POST['bom_name'] ?? '')); $yield=parse_number_input($_POST['yield_qty'] ?? 1);
